...
import kr.co.lion.android01.firstusemvvmproject.fragment.AllMemoFragment
import kr.co.lion.android01.firstusemvvmproject.fragment.InputMemoFragment
import kr.co.lion.android01.firstusemvvmproject.fragment.ModifyMemoFragment
import kr.co.lion.android01.firstusemvvmproject.fragment.ShowMemoFragment
...
class LoginActivity : AppCompatActivity() {
    ...
    fun replaceFragment(name:FragmentMemoName, addToBackStack:Boolean, isAnimate:Boolean, data:Bundle?){
        ...
        when(name){
            FragmentMemoName.ALL_MEMO_FRAGMENT -> {
                newFragment = AllMemoFragment()
            }
            FragmentMemoName.INPUT_MEMO_FRAGMENT -> {
                newFragment = InputMemoFragment()
            }
            FragmentMemoName.SHOW_MEMO_FRAGMENT -> {
                newFragment = ShowMemoFragment()
            }
            FragmentMemoName.MODIFY_MEMO_FRAGMENT -> {
                newFragment = ModifyMemoFragment()
            }
        }
    ...
    fun removeFragment(name:FragmentMemoName){
        SystemClock.sleep(200)
